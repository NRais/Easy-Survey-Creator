...
The 5th release fixes bugs in the UI and increases user-friendliness making it easier to use. It also adds "import" and "export" options in for surveys in the creation menu.

Version 2.0.5 Jar - Fifth Stable Release. The Jar is an alternate application version that has the advantage of small size. It is an application that can be run on any system with Java JRE 7 or greater.
Version 2.0.5 - Fifth Stable Release. The Easy Survey Creator 2.0.5 setup is a standalone installer for Windows 7+.

--- INSTALLATION ---

Version 2.0.5-Setup is a standalone installer that can install the Easy Survey Creator. Windows 7+ supported.
...
Version 2.0.5-Jar is a application that can be run on any system with Java JRE 7 or greater.

To install ensure you have a Java JRE 7+ installed. (see http://www.oracle.com/technetwork/java/javase/downloads/index.html)
Simply double-click the .jar and run it.
