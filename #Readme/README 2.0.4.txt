...
The 4th release adds a new 'summary' feature to the Analysis menu and fixes a errors with the analysis menu.

Version 2.0.4 Jar - Fourth Stable Release. The Jar is an alternate application version that has the advantage of small size. It is an application that can be run on any system with Java JRE 7 or greater.
Version 2.0.4 - Fourth Stable Release. Version 2.0.4 improves the installation of the Easy Survey Creator using inno5 and exe4j.

--- INSTALLATION ---

Version 2.0.4 Jar is a application that can be run on any system with Java JRE 7 or greater.
...
Version 2.0.4 is a standalone installer that can install the Easy Survey Creator. Windows 7+ supported.
