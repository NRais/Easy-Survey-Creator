...
Version 2.1.1 Jar - The Jar is an alternate application version. It is an application that can be run on any coomputer that has Java
Version 2.1.1 - The Easy Survey Creator 2.1.1 setup is a standalone installer for Windows 7+.
...
- Version 2.1.1-Setup is a standalone installer that can install the Easy Survey Creator. Windows 7+ supported.
...
- Version 2.1.1-Jar is a application that can be run on any system with a JRE 7 or greater.
